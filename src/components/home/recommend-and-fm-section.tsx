...
function RecommendCard() {
	...
	return (
		<div
			className="w-full h-full bg-(--dynamic-color) rounded-lg overflow-hidden relative text-white drop-shadow-[0_10px_8px_rgba(0,0,0,0.1)]"
			style={
				{
		...
		>
			...
			<div className="relative z-10 w-full h-full p-6 flex flex-col justify-between">
				...
				<div className="flex flex-col gap-2">
					...
					<Button
						className="w-24 bg-(--dynamic-color) border-b-(--light-vibrant) border-b-2 drop-shadow-lg font-light transition-all duration-300 hover:brightness-110 hover:shadow-xl text-white"
