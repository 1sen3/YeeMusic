  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <div
          className={cn(
            "inline-flex items-center gap-1.5 rounded-sm border-0 px-2 py-1 font-medium text-xs text-white/40 transition-colors duration-300 ease-out select-none mix-blend-plus-lighter backdrop-blur-md bg-white/5 hover:bg-white/10",
