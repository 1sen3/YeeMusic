...
export function SongPreviewItem({ song }: { song: Song }) {
  ...
  return (
    ...
    >
      <div
        className="w-16 h-16 rounded-sm overflow-hidden relative border"
      ...
      >
        ...
        <div className="opacity-0 group-hover:opacity-100 bg-black/50 absolute top-0 left-0 w-full h-full flex items-center justify-center text-foreground transform transition-all duration-300 ease-in-out">
          <SFIcon
      ...
      <div className="flex items-center gap-4 opacity-0 group-hover:opacity-100 pr-8 translate-x-20 group-hover:translate-x-0 transform transition-all duration-300 ease-in-out">
        <YeeButton
          ...
          className={cn(
            "text-foreground hover:text-foreground/80 rounded-full",
