...
export function ContextMenuSeperator() {
  return <div className="h-px bg-foreground/10 my-2 mx-1" />;
}
export function ContextMenuButton({
  ...
  return (
    <div
      className="yee-context-menu-item flex gap-2 p-2 items-center text-sm rounded-md relative"
      onClick={onClick}
    ...
    >
      ...
      {hasSubmenu && showSubmenu && children && (
        ...
        >
          <IsolatedSubmenu>
            <div className="no-scrollbar yee-context-submenu-surface w-48 rounded-lg flex flex-col p-2 max-h-[300px] overflow-y-auto">
              {children}
            </div>
          </IsolatedSubmenu>
        </div>
