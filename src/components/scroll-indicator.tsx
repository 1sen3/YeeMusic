...
export function ScrollIndicator() {
	...
	return (
		...
		>
			<div
				className="absolute right-1 w-1 cursor-default rounded-full bg-black/30 opacity-0 transition-[opacity,width,background-color] duration-150 hover:w-1.5 dark:bg-white/35"
